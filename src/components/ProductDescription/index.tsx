  ...
  getProductPrice = () => {
    ...
    if (variantPricing) {
      if (isEqual(variantPricing.priceUndiscounted, variantPricing.price)) {
        ...
        return (
          <>
            <div className="product-description__currency">MUR</div>
            <div>
              <span className="product-description__undiscounted_price">
                {/* <TaxedMoney taxedMoney={variantPricing.priceUndiscounted} /> */}
                {variantPricing.priceUndiscounted.gross.amount.toLocaleString(
                  undefined,
                  {
              ...
              <span className="product-description__price">
                ...
                {variantPricing.price.gross.amount.toLocaleString(undefined, {
                  maximumFractionDigits: 2,
                  minimumFractionDigits: 2,
                })}
              </span>
